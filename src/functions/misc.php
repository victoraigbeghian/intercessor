...
if ( ! function_exists( 'intercessor_setup_pages' ) ) {
	/**
	 * Set up required pages.
	 *
	 * @since 1.0.0
	 */
	function intercessor_setup_pages() {
...
if ( ! function_exists( 'intercessor_setup_default_options' ) ) {
	/**
	 ...
	 */
	function intercessor_setup_default_options() {
